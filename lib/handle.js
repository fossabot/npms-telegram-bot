...
const rndStr = require(`${__dirname}/rndStr`)
const resLog = require(`${__dirname}/resLog`)
    ...
    req.on('end', () => {
      if (isJson(s)) {
        ...
        if (j.message && j.message.chat && j.message.chat.type === 'private') {
          ...
          hit(j.inline_query.from.id, 'callback query')
          ...
          // 0|npms     | [ { id: '271228992163371560',
          // 0|npms     |     from:
          // 0|npms     |      { id: 63150420,
          // 0|npms     |        first_name: 'Alexander',
          // 0|npms     |        last_name: 'M',
          // 0|npms     |        username: 'kekDude',
          // 0|npms     |        language_code: 'ru-RU' },
          // 0|npms     |     query: '',
          // 0|npms     |     offset: '' } ]
          // inline mode
